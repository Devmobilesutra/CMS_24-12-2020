...
public class ReplacementLine {
    ...
    String keyField,document_NoField,line_noField,line_noFieldSpecified,entry_TypeField,entry_TypeFieldSpecified,
            ...
            item_Code_SubstituteField,item_Description_SubstituteField,reason_Code_SubstituteField,uOM_SubstituteField,enginner_comments,transfer_Order_NoField;


    public ReplacementLine(String item_CodeField, String item_DescriptionField, String location_CodeField, String quantityField, String unit_of_MeasurementField, String reason_CodeField, String entry_Type_SubstituteField, String item_Code_SubstituteField, String item_Description_SubstituteField, String reason_Code_SubstituteField, String uOM_SubstituteField, String transfer_Order_NoField) {
       ...
       // this.enginner_comments = enginner_comments;
        this.transfer_Order_NoField = transfer_Order_NoField;
    }
    ...
    public String getTransfer_Order_NoField() {
        return transfer_Order_NoField;
    }

    public void setTransfer_Order_NoField(String transfer_Order_NoField) {
        this.transfer_Order_NoField = transfer_Order_NoField;
    }
}
