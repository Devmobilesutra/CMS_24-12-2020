...
public class CallDetailsActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initUI() {
       ...
       // attachments.setOnClickListener(CallDetailsActivity.this);
        ...
        /*Prefs.with(CallDetailsActivity.this).remove(Constant.FCRAttachment);
        Prefs.with(CallDetailsActivity.this).remove(Constant.InstallationCertificate);
        Prefs.with(CallDetailsActivity.this).remove(Constant.ATMImages1);
        Prefs.with(CallDetailsActivity.this).remove(Constant.ATMImages2);
        Prefs.with(CallDetailsActivity.this).remove(Constant.TransactionImage1);
        Prefs.with(CallDetailsActivity.this).remove(Constant.TransactionImage2);
        Prefs.with(CallDetailsActivity.this).remove(Constant.ErrorHistory);*/
