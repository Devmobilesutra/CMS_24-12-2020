...
public class CallClloserActivity extends AppCompatActivity {
    ...
    File outPutFile;
    String FCRAttachment_uploadedFile = null;
    //String uploadedFile  = null;
    String InstallationCertificate_uploadedFile = null;
    String ATMImages1_uploadedFile = null;
    String ATMImages2_uploadedFile = null;

    String TransactionImage1_uploadedFile = null;
    String TransactionImage2_uploadedFile = null;

    String ErrorHistory_uploadedFile = null;
    ...
    private ArrayList<ImageModel> image_Model= new ArrayList<>();;
   ...
   /* private String TransactioDateTime;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        call_types = (getIntent().getStringExtra("CALL_TYPE_VALUES"));


        Log.d("", "onCreateCALL_TYPES: " + call_types);
        ...
        btnFCRAttachmentupload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                choosePicture();
                UploadBtnValue = "Call Closure FCR Attachment";
            }
        });
        btnInstallationCertificateupload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                choosePicture();
                UploadBtnValue = "Installation Certificate";
            }
        });
        ...
        btnTransactionImageupload_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                choosePicture();
                UploadBtnValue = "Transaction Image1";
            }
        });
        btnTransactionImageupload_2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                choosePicture();
                UploadBtnValue = "Transaction Image2";
            }
        });
      ...
      /*  new GetCallClosureImages(Constants.GetCallCloserImages+ "?DocketNo=" + RepairDetailsActivity.docket_no, "GET"
                , CallClloserActivity.this).execute();*/
        ...
        Save_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (validation()) {
                    ...
                    //Toast.makeText(CallClloserActivity.this, "not Valid something", Toast.LENGTH_SHORT).show();
                }
    ...
    public void  GetUploadImages(){
        ...
        if (Prefs.with(CallClloserActivity.this).getString(Constant.FCRAttachment, "") != null && Prefs.with(CallClloserActivity.this).getString(Constant.FCRAttachment, "") != "") {
            byte[] decodedString = Base64.decode(Prefs.with(CallClloserActivity.this).getString(Constant.FCRAttachment, ""), Base64.DEFAULT);
            ...
            FCRAttachment_uploadedFile = (Prefs.with(CallClloserActivity.this).getString(Constant.FCRAttachment, ""));
            Log.d("TAG", "GetUploadImages: "+ FCRAttachment_uploadedFile);
            JSONObject postParamData = new JSONObject();

            try {
                postParamData.put("DocketNo", RepairDetailsActivity.docket_no);
                postParamData.put("File", FCRAttachment_uploadedFile.trim());
                postParamData.put("FileName", RepairDetailsActivity.userId + String.valueOf(System.currentTimeMillis()) + ".jpg");
                postParamData.put("Comments", "Call Closure FCR Attachment");
        ...
        //// InstallationCertificate images
        if (Prefs.with(CallClloserActivity.this).getString(Constant.InstallationCertificate, "") != null && Prefs.with(CallClloserActivity.this).getString(Constant.InstallationCertificate, "") != "") {
            byte[] decodedString = Base64.decode(Prefs.with(CallClloserActivity.this).getString(Constant.InstallationCertificate, ""), Base64.DEFAULT);
            // Bitmap decodedByte = BitmapFactory.decodeByteArray(decodedString, 0, decodedString.length);
            ...
            InstallationCertificate_uploadedFile = (Prefs.with(CallClloserActivity.this).getString(Constant.InstallationCertificate, ""));
            Log.d("TAG", "InstallationCertificate_uploadedFile: "+ InstallationCertificate_uploadedFile);
            JSONObject postParamData = new JSONObject();

            try {
                postParamData.put("DocketNo", RepairDetailsActivity.docket_no);
                postParamData.put("File", InstallationCertificate_uploadedFile.trim());
                postParamData.put("FileName", RepairDetailsActivity.userId + String.valueOf(System.currentTimeMillis()) + ".jpg");
                postParamData.put("Comments", "Installation Certificate");
                //  return doWork(postParamData);
            } catch (JSONException e) {
                e.printStackTrace();
            }
        ...
        if (Prefs.with(CallClloserActivity.this).getString(Constant.ATMImages1, "") != null && Prefs.with(CallClloserActivity.this).getString(Constant.ATMImages1, "") != "") {
            byte[] decodedString = Base64.decode(Prefs.with(CallClloserActivity.this).getString(Constant.ATMImages1, ""), Base64.DEFAULT);
            // Bitmap decodedByte = BitmapFactory.decodeByteArray(decodedString, 0, decodedString.length);
            ...
            ATMImages1_uploadedFile = (Prefs.with(CallClloserActivity.this).getString(Constant.ATMImages1, ""));
            Log.d("TAG", "ATMImages1_uploadedFile: "+ ATMImages1_uploadedFile);
            JSONObject postParamData = new JSONObject();

            try {
                postParamData.put("DocketNo", RepairDetailsActivity.docket_no);
                postParamData.put("File", ATMImages1_uploadedFile.trim());
                postParamData.put("FileName", RepairDetailsActivity.userId + String.valueOf(System.currentTimeMillis()) + ".jpg");
                postParamData.put("Comments", "ATM Images1");
                //  return doWork(postParamData);
            } catch (JSONException e) {
                e.printStackTrace();
            }
        ...
        if (Prefs.with(CallClloserActivity.this).getString(Constant.ATMImages2, "") != null && Prefs.with(CallClloserActivity.this).getString(Constant.ATMImages2, "") != "") {
            byte[] decodedString = Base64.decode(Prefs.with(CallClloserActivity.this).getString(Constant.ATMImages2, ""), Base64.DEFAULT);
            // Bitmap decodedByte = BitmapFactory.decodeByteArray(decodedString, 0, decodedString.length);
            ...
            ATMImages2_uploadedFile = (Prefs.with(CallClloserActivity.this).getString(Constant.ATMImages2, ""));
            Log.d("TAG", "ATMImages1_uploadedFile: "+ ATMImages2_uploadedFile);
            JSONObject postParamData = new JSONObject();

            try {
                postParamData.put("DocketNo", RepairDetailsActivity.docket_no);
                postParamData.put("File", ATMImages2_uploadedFile.trim());
                postParamData.put("FileName", RepairDetailsActivity.userId + String.valueOf(System.currentTimeMillis()) + ".jpg");
                postParamData.put("Comments", "ATM Images2");
                //  return doWork(postParamData);
            } catch (JSONException e) {
                e.printStackTrace();
            }
        ...
        if (Prefs.with(CallClloserActivity.this).getString(Constant.TransactionImage1, "") != null && Prefs.with(CallClloserActivity.this).getString(Constant.TransactionImage1, "") != "") {
            byte[] decodedString = Base64.decode(Prefs.with(CallClloserActivity.this).getString(Constant.TransactionImage1, ""), Base64.DEFAULT);
            // Bitmap decodedByte = BitmapFactory.decodeByteArray(decodedString, 0, decodedString.length);
            ...
            TransactionImage1_uploadedFile = (Prefs.with(CallClloserActivity.this).getString(Constant.TransactionImage1, ""));
            Log.d("TAG", "TransactionImage1_uploadedFile: "+ TransactionImage1_uploadedFile);
            JSONObject postParamData = new JSONObject();

            try {
                postParamData.put("DocketNo", RepairDetailsActivity.docket_no);
                postParamData.put("File", TransactionImage1_uploadedFile.trim());
                postParamData.put("FileName", RepairDetailsActivity.userId + String.valueOf(System.currentTimeMillis()) + ".jpg");
                postParamData.put("Comments", "Transaction Image1");
                //  return doWork(postParamData);
            } catch (JSONException e) {
                e.printStackTrace();
            }
        ...
        if (Prefs.with(CallClloserActivity.this).getString(Constant.TransactionImage2, "") != null && Prefs.with(CallClloserActivity.this).getString(Constant.TransactionImage2, "") != "") {
            byte[] decodedString = Base64.decode(Prefs.with(CallClloserActivity.this).getString(Constant.TransactionImage2, ""), Base64.DEFAULT);
            // Bitmap decodedByte = BitmapFactory.decodeByteArray(decodedString, 0, decodedString.length);
            ...
            TransactionImage2_uploadedFile = (Prefs.with(CallClloserActivity.this).getString(Constant.TransactionImage2, ""));
            Log.d("TAG", "TransactionImage2_uploadedFile: "+ TransactionImage2_uploadedFile);
            JSONObject postParamData = new JSONObject();

            try {
                postParamData.put("DocketNo", RepairDetailsActivity.docket_no);
                postParamData.put("File", TransactionImage2_uploadedFile.trim());
                postParamData.put("FileName", RepairDetailsActivity.userId + String.valueOf(System.currentTimeMillis()) + ".jpg");
                postParamData.put("Comments", "Transaction Image2");
                //  return doWork(postParamData);
            } catch (JSONException e) {
                e.printStackTrace();
            }
        ...
        if (Prefs.with(CallClloserActivity.this).getString(Constant.ErrorHistory, "") != null && Prefs.with(CallClloserActivity.this).getString(Constant.ErrorHistory, "") != "") {
            byte[] decodedString = Base64.decode(Prefs.with(CallClloserActivity.this).getString(Constant.ErrorHistory, ""), Base64.DEFAULT);
            // Bitmap decodedByte = BitmapFactory.decodeByteArray(decodedString, 0, decodedString.length);
            ...
            ErrorHistory_uploadedFile = (Prefs.with(CallClloserActivity.this).getString(Constant.ErrorHistory, ""));
            Log.d("TAG", "ErrorHistory_uploadedFile: "+ ErrorHistory_uploadedFile);
            JSONObject postParamData = new JSONObject();

            try {
                postParamData.put("DocketNo", RepairDetailsActivity.docket_no);
                postParamData.put("File", ErrorHistory_uploadedFile.trim());
                postParamData.put("FileName", RepairDetailsActivity.userId + String.valueOf(System.currentTimeMillis()) + ".jpg");
                postParamData.put("Comments", "Error History");
                //  return doWork(postParamData);
            } catch (JSONException e) {
                e.printStackTrace();
            }
                ...
                try {
                    if (json.has("Status") && json.get("Status").toString().equalsIgnoreCase("Success")) {
                        if (json.getJSONArray("PayLoad").get(0).toString().equalsIgnoreCase("No record(s) to display.")) {
                            ...
                            Utils.showAlertBox(json.getJSONArray("PayLoad").get(0).toString(), CallClloserActivity.this);
                        } else {
                            ...
                            for (int i = 0; i < respSubstatusList.length(); i++) {
                                ...
                                if(jsonData.getString("Description").equalsIgnoreCase("Call Closure FCR Attachment")){
                                    ...
                                    Prefs.with(CallClloserActivity.this).save(Constant.FCRAttachment, image);


                                    if (FCRAttachment_uploadedFile != null && FCRAttachment_uploadedFile != "") {
                                        byte[] decodedString = Base64.decode(FCRAttachment_uploadedFile, Base64.DEFAULT);
                                        // Bitmap decodedByte = BitmapFactory.decodeByteArray(decodedString, 0, decodedString.length);
                                        Glide.with(CallClloserActivity.this).load(decodedString).crossFade().fitCenter().into(FCRAttachmentimageView);
                                        btnFCRAttachmentupload.setText("Change Image");
                                    }
                                ...
                                if(jsonData.getString("Description").equalsIgnoreCase("Installation Certificate")){
                                    ...
                                    Prefs.with(CallClloserActivity.this).save(Constant.InstallationCertificate, image_string);
                                ...
                                if(jsonData.getString("Description").equalsIgnoreCase("ATM Images1")){
                                    ...
                                    String image_string = jsonData.getString("Image");
                                    Prefs.with(CallClloserActivity.this).save(Constant.ATMImages1, image_string);
                                ...
                                if(jsonData.getString("Description").equalsIgnoreCase("ATM Images2")){
                                    ...
                                    String image_string = jsonData.getString("Image");
                                    Prefs.with(CallClloserActivity.this).save(Constant.ATMImages2, image_string);
                                ...
                                if(jsonData.getString("Description").equalsIgnoreCase("Transaction Image1")){
                                    ...
                                    String image_string = jsonData.getString("Image");
                                    Prefs.with(CallClloserActivity.this).save(Constant.TransactionImage1, image_string);
                                ...
                                if(jsonData.getString("Description").equalsIgnoreCase("Transaction Image2")){
                                    ...
                                    String image_string = jsonData.getString("Image");
                                    Prefs.with(CallClloserActivity.this).save(Constant.TransactionImage2, image_string);
                                ...
                                if(jsonData.getString("Description").equalsIgnoreCase("Error History")){
                                    ...
                                    String image_string = jsonData.getString("Image");
                                    Prefs.with(CallClloserActivity.this).save(Constant.ErrorHistory, image_string);
...
*/
  ...
  /*      if(ImagesJsonArray != null)
        ...
        if (requestCode == GALLERY_CODE && resultCode == Activity.RESULT_OK && null != data) {
            ...
            try {
                if (resultCode == RESULT_OK) {
                    ...
                    if (UploadBtnValue == "Call Closure FCR Attachment") {
                        btnFCRAttachmentupload.setText("Change Image");
                        ...
                        if (imgFile.exists() && imgFile.length() > 0) {
                            ...
                            FCRAttachment_uploadedFile = Base64.encodeToString(bOut.toByteArray(), Base64.DEFAULT);
                            Prefs.with(CallClloserActivity.this).save(Constant.FCRAttachment, FCRAttachment_uploadedFile);
                    ...
                    } else if (UploadBtnValue == "Installation Certificate") {
                        btnInstallationCertificateupload.setText("Change Image");
                        ...
                        if (imgFile.exists() && imgFile.length() > 0) {
                            ...
                            ByteArrayOutputStream bOut = new ByteArrayOutputStream();
                            bm.compress(Bitmap.CompressFormat.JPEG, 30, bOut);
                            InstallationCertificate_uploadedFile = Base64.encodeToString(bOut.toByteArray(), Base64.DEFAULT);
                            Prefs.with(CallClloserActivity.this).save(Constant.InstallationCertificate, InstallationCertificate_uploadedFile);
                            if (ImagesJsonArray != null) {
                                for (int i = 0; i < ImagesJsonArray.length(); i++) {
                                    JSONObject testObj = ImagesJsonArray.getJSONObject(i);
                                    String name = testObj.getString("Comments");
                    ...
                    } else if (UploadBtnValue == "ATM Images1") {
                        btnATMImagesupload_1.setText("Change Image");
                        ...
                        if (imgFile.exists() && imgFile.length() > 0) {
                            ...
                            ATMImages1_uploadedFile = Base64.encodeToString(bOut.toByteArray(), Base64.DEFAULT);
                            Prefs.with(CallClloserActivity.this).save(Constant.ATMImages1, ATMImages1_uploadedFile);
                            if (ImagesJsonArray != null) {
                                for (int i = 0; i < ImagesJsonArray.length(); i++) {
                                    JSONObject testObj = ImagesJsonArray.getJSONObject(i);
                                    String name = testObj.getString("Comments");
                            ...
                            try {
                                postParamData.put("DocketNo", RepairDetailsActivity.docket_no);
                                postParamData.put("File", ATMImages1_uploadedFile);
                                postParamData.put("FileName", RepairDetailsActivity.userId + String.valueOf(System.currentTimeMillis()) + ".jpg");
                                postParamData.put("Comments", UploadBtnValue);
                                //  return doWork(postParamData);
                            } catch (JSONException e) {
                    ...
                    } else if (UploadBtnValue == "ATM Images2") {
                        btnATMImagesupload_2.setText("Change Image");
                        ...
                        if (imgFile.exists() && imgFile.length() > 0) {
                            ...
                            ByteArrayOutputStream bOut = new ByteArrayOutputStream();
                            bm.compress(Bitmap.CompressFormat.JPEG, 50, bOut);
                            ATMImages2_uploadedFile = Base64.encodeToString(bOut.toByteArray(), Base64.DEFAULT);
                            Prefs.with(CallClloserActivity.this).save(Constant.ATMImages2, ATMImages2_uploadedFile);
                            if (ImagesJsonArray != null) {
                                for (int i = 0; i < ImagesJsonArray.length(); i++) {
                                    JSONObject testObj = ImagesJsonArray.getJSONObject(i);
                                    String name = testObj.getString("Comments");
                    ...
                    } else if (UploadBtnValue == "Transaction Image1") {
                        btnTransactionImageupload_1.setText("Change Image");
                        ...
                        if (imgFile.exists() && imgFile.length() > 0) {
                            ...
                            ByteArrayOutputStream bOut = new ByteArrayOutputStream();
                            bm.compress(Bitmap.CompressFormat.JPEG, 50, bOut);
                            TransactionImage1_uploadedFile = Base64.encodeToString(bOut.toByteArray(), Base64.DEFAULT);
                            Prefs.with(CallClloserActivity.this).save(Constant.TransactionImage1, TransactionImage1_uploadedFile);
                            if (ImagesJsonArray != null) {
                                for (int i = 0; i < ImagesJsonArray.length(); i++) {
                                    JSONObject testObj = ImagesJsonArray.getJSONObject(i);
                                    String name = testObj.getString("Comments");
                            ...
                            try {
                                postParamData.put("DocketNo", RepairDetailsActivity.docket_no);
                                postParamData.put("File", TransactionImage1_uploadedFile);
                                postParamData.put("FileName", RepairDetailsActivity.userId + String.valueOf(System.currentTimeMillis()) + ".jpg");
                                postParamData.put("Comments", UploadBtnValue);
                                //  return doWork(postParamData);
                            } catch (JSONException e) {
                    ...
                    } else if (UploadBtnValue == "Transaction Image2") {
                        btnTransactionImageupload_2.setText("Change Image");
                        ...
                        if (imgFile.exists() && imgFile.length() > 0) {
                            ...
                            ByteArrayOutputStream bOut = new ByteArrayOutputStream();
                            bm.compress(Bitmap.CompressFormat.JPEG, 50, bOut);
                            TransactionImage2_uploadedFile = Base64.encodeToString(bOut.toByteArray(), Base64.DEFAULT);
                            Prefs.with(CallClloserActivity.this).save(Constant.TransactionImage2, TransactionImage2_uploadedFile);
                            if (ImagesJsonArray != null) {
                                for (int i = 0; i < ImagesJsonArray.length(); i++) {
                                    JSONObject testObj = ImagesJsonArray.getJSONObject(i);
                                    String name = testObj.getString("Comments");
                            ...
                            try {
                                postParamData.put("DocketNo", RepairDetailsActivity.docket_no);
                                postParamData.put("File", TransactionImage2_uploadedFile);
                                postParamData.put("FileName", RepairDetailsActivity.userId + String.valueOf(System.currentTimeMillis()) + ".jpg");
                                postParamData.put("Comments", UploadBtnValue);
                                //  return doWork(postParamData);
                            } catch (JSONException e) {
                    ...
                    } else if (UploadBtnValue == "Error History") {
                        btnErrorHistoryimgupload.setText("Change Image");
                        ...
                        if (imgFile.exists() && imgFile.length() > 0) {
                            ...
                            ByteArrayOutputStream bOut = new ByteArrayOutputStream();
                            bm.compress(Bitmap.CompressFormat.JPEG, 50, bOut);
                            ErrorHistory_uploadedFile = Base64.encodeToString(bOut.toByteArray(), Base64.DEFAULT);
                            Prefs.with(CallClloserActivity.this).save(Constant.ErrorHistory, ErrorHistory_uploadedFile);
                            if (ImagesJsonArray != null) {
                                for (int i = 0; i < ImagesJsonArray.length(); i++) {
                                    JSONObject testObj = ImagesJsonArray.getJSONObject(i);
                                    String name = testObj.getString("Comments");
                            ...
                            try {
                                postParamData.put("DocketNo", RepairDetailsActivity.docket_no);
                                postParamData.put("File", ErrorHistory_uploadedFile);
                                postParamData.put("FileName", RepairDetailsActivity.userId + String.valueOf(System.currentTimeMillis()) + ".jpg");
                                postParamData.put("Comments", UploadBtnValue);
                                //  return doWork(postParamData);
                            } catch (JSONException e) {
    ...
    public boolean validation() {
        ...
        Log.d("", "validationproblemFixstr: " + problemFixstr);

        if (problemFixstr == null || problemFixstr == "") {
            Toast.makeText(getApplicationContext(), "Please select Problem Fix", Toast.LENGTH_LONG).show();
            return false;

        } else if (solutionstr == null || solutionstr == "") {

            Toast.makeText(getApplicationContext(), "Please select Solution", Toast.LENGTH_LONG).show();

            return false;

        } else if (RespCategorystr == null || RespCategorystr == "") {

            Toast.makeText(getApplicationContext(), "Please select Response Category", Toast.LENGTH_LONG).show();

            return false;

        } else if (ActivityTypestr == "--Select--" || ActivityTypestr == null) {

            Toast.makeText(getApplicationContext(), "Please select Activity Type", Toast.LENGTH_LONG).show();

            return false;

        } else if (TextUtils.isEmpty(tvTransactionDateTime.getText().toString())) {

            Toast.makeText(getApplicationContext(), "Please select Transaction Date/Time", Toast.LENGTH_LONG).show();

            return false;
        } else if (Prefs.with(CallClloserActivity.this).getString(Constant.FCRAttachment, "") == ""  ) {

            Toast.makeText(getApplicationContext(), "Please Upload FCRAttachment Images", Toast.LENGTH_LONG).show();

            return false;


        } else if (call_types.equalsIgnoreCase("INST/UPG")&& Prefs.with(CallClloserActivity.this).getString(Constant.InstallationCertificate, "") == "") {
           /// if (Prefs.with(CallClloserActivity.this).getString(Constant.InstallationCertificate, "") == "") {

                Toast.makeText(getApplicationContext(), "Please Upload InstallationCertificate Images", Toast.LENGTH_LONG).show();

                return false;

           // }

        } else if (Prefs.with(CallClloserActivity.this).getString(Constant.ATMImages1, "") == "" || Prefs.with(CallClloserActivity.this).getString(Constant.ATMImages2, "")== "") {

            Toast.makeText(getApplicationContext(), "Please Upload ATM Images", Toast.LENGTH_LONG).show();

            return false;

        } else if (Prefs.with(CallClloserActivity.this).getString(Constant.TransactionImage1, "")== "" || Prefs.with(CallClloserActivity.this).getString(Constant.TransactionImage2, "") == "") {

            Toast.makeText(getApplicationContext(), "Please Upload Transaction Images", Toast.LENGTH_LONG).show();

            return false;

        } else if (Prefs.with(CallClloserActivity.this).getString(Constant.ErrorHistory, "") == "") {

            Toast.makeText(getApplicationContext(), "Please Upload ErrorHistory Images", Toast.LENGTH_LONG).show();
             ...
             /*           SpinnerErrorCode.setItems(spinnerProblemFixArray, -1, new SpinnerListener() {
                        ...
                        if(ErrorCodestr != null)
                        {
                            ...
                            for (int i = 0; i < ErrorCodelist.size(); i++) {
                                ...
                                KeyPairBoolData h = new KeyPairBoolData();
                                h.setId(i + 1);
                                h.setName(ErrorCodelist.get(i).getCode());
                                h.setCode(ErrorCodelist.get(i).getCode());
                                for (int j = 0;j < arr.length;j++)
                                {
